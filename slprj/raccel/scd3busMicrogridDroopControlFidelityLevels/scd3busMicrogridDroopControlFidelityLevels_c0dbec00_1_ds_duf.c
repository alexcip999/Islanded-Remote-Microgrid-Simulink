...
intermediate_der1001 ; real_T intermediate_der1002 ; real_T
intermediate_der1003 ; real_T intermediate_der1008 ; real_T intermediate_der2
...
intermediate_der1001 = 0.0 ; } else { intermediate_der1001 = ( real_T ) ( t56
-> mM . mX [ 34ULL ] == 0 ) ; } if ( t56 -> mM . mX [ 37ULL ] != 0 ) {
intermediate_der1002 = 0.0 ; } else { intermediate_der1002 = ( real_T ) ( t56
-> mM . mX [ 38ULL ] == 0 ) ; } if ( t56 -> mM . mX [ 40ULL ] != 0 ) {
intermediate_der1003 = 0.0 ; } else { intermediate_der1003 = ( real_T ) ( t56
-> mM . mX [ 41ULL ] == 0 ) ; } if ( t56 -> mM . mX [ 30ULL ] != 0 ) {
intermediate_der1008 = 0.0 ; } else { intermediate_der1008 = ( real_T ) ( t56
...
- zc_int24 ) ; out -> mDUF . mX [ 0ULL ] = - ( - intermediate_der1001 * ( - ( t56 -> mX . mX [ 122ULL ] * zc_int24 ) / ( intermediate_der2 == 0.0 ? 1.0E-16 : intermediate_der2 ) ) + t56 -> mX . mX [ 122ULL ] * intermediate_der1001 / ( 1.0 - zc_int24 == 0.0 ? 1.0E-16 : 1.0 - zc_int24 ) ) ; out -> mDUF . mX [ 1ULL ] = - ( - intermediate_der1001 * ( - ( Inverter_2_Solar_Power_4_Average_Value_DC_DC_Converter_i2 * zc_int24 ) / ( intermediate_der2 == 0.0 ? 1.0E-16 : intermediate_der2 ) ) + Inverter_2_Solar_Power_4_Average_Value_DC_DC_Converter_i2 * intermediate_der1001 / ( 1.0 - zc_int24 == 0.0 ? 1.0E-16 : 1.0 - zc_int24 ) ) ; zc_int24 = ( 1.0 - t55 ) * ( 1.0 - t55 ) ; out -> mDUF . mX [ 3ULL ] = - ( - intermediate_der1002 * ( - ( t56 -> mX . mX [ 156ULL ] * t55 ) / ( zc_int24 == 0.0 ? 1.0E-16 : zc_int24 ) ) + t56 -> mX . mX [ 156ULL ] * intermediate_der1002 / ( 1.0 - t55 == 0.0 ? 1.0E-16 : 1.0 - t55 ) ) ; out -> mDUF . mX [ 4ULL ] = - ( - intermediate_der1002 * ( - ( t16 * t55 ) / ( zc_int24 == 0.0 ? 1.0E-16 : zc_int24 ) ) + t16 * intermediate_der1002 / ( 1.0 - t55 == 0.0 ? 1.0E-16 : 1.0 - t55 ) ) ; zc_int24 = ( 1.0 - zc_int28 ) * ( 1.0 - zc_int28 ) ; out -> mDUF . mX [ 6ULL ] = - ( - intermediate_der1003 * ( - ( t56 -> mX . mX [ 190ULL ] * zc_int28 ) / ( zc_int24 == 0.0 ? 1.0E-16 : zc_int24 ) ) + t56 -> mX . mX [ 190ULL ] * intermediate_der1003 / ( 1.0 - zc_int28 == 0.0 ? 1.0E-16 : 1.0 - zc_int28 ) ) ; out -> mDUF . mX [ 7ULL ] = - ( - intermediate_der1003 * ( - ( t18 * zc_int28 ) / ( zc_int24 == 0.0 ? 1.0E-16 : zc_int24 ) ) + t18 * intermediate_der1003 / ( 1.0 - zc_int28 == 0.0 ? 1.0E-16 : 1.0 - zc_int28 ) ) ; zc_int24 = ( 1.0 - zc_int30 ) * ( 1.0 - zc_int30 ) ; out -> mDUF . mX [ 9ULL ] = - ( - intermediate_der1008 * ( - ( t56 -> mX . mX [ 202ULL ] * zc_int30 ) / ( zc_int24 == 0.0 ? 1.0E-16 : zc_int24 ) ) + t56 -> mX . mX [ 202ULL ] * intermediate_der1008 / ( 1.0 - zc_int30 == 0.0 ? 1.0E-16 : 1.0 - zc_int30 ) ) ; out -> mDUF . mX [ 10ULL ] = - ( - intermediate_der1008 * ( - ( Solar_Power_1_Average_Value_DC_DC_Converter_i2 * zc_int30 ) / ( zc_int24 == 0.0 ? 1.0E-16 : zc_int24 ) ) + Solar_Power_1_Average_Value_DC_DC_Converter_i2 * intermediate_der1008 / ( 1.0 - zc_int30 == 0.0 ? 1.0E-16 : 1.0 - zc_int30 ) ) ; ( void ) LC ; ( void ) out ; return 0 ; }
