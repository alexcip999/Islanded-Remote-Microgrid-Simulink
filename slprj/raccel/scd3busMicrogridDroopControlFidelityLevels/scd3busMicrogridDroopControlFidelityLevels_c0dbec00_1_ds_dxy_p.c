...
18 , 22 , 23 } ; int32_T i ; ( void ) t1 ; ( void ) LC ; out -> mDXY_P .
mNumCol = 153ULL ; out -> mDXY_P . mNumRow = 24ULL ; for ( i = 0 ; i < 154 ;
i ++ ) { out -> mDXY_P . mJc [ i ] = _cg_const_1 [ i ] ; } for ( i = 0 ; i <
141 ; i ++ ) { out -> mDXY_P . mIr [ i ] = _cg_const_2 [ i ] ; } ( void ) LC
; ( void ) out ; return 0 ; }
