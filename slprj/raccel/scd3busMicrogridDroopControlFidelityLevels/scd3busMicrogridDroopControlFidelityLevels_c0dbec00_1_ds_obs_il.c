...
#include "scd3busMicrogridDroopControlFidelityLevels_c0dbec00_1_ds_obs_il.h"
...
int32_T scd3busMicrogridDroopControlFidelityLevels_c0dbec00_1_ds_obs_il ( const
NeDynamicSystem * LC , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
out ) { static boolean_T _cg_const_1 [ 1630 ] = { true , true , true , false
...
true , true , true , true , true , true , true , true , true , true , true ,
false , true , true , true , true , true , true , true , true , true , true ,
true , true , true , true , true , true , true , true , false } ; int32_T i ;
( void ) t1 ; ( void ) LC ; for ( i = 0 ; i < 1630 ; i ++ ) { out -> mOBS_IL
