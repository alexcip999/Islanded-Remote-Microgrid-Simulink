...
#include "scd3busMicrogridDroopControlFidelityLevels_c0dbec00_1_ds_slv.h"
...
int32_T scd3busMicrogridDroopControlFidelityLevels_c0dbec00_1_ds_slv ( const
...
, true , true , true } ; ( void ) t1 ; ( void ) LC ; out -> mSLV . mX [ 0 ] =
_cg_const_1 [ 0 ] ; out -> mSLV . mX [ 1 ] = _cg_const_1 [ 1 ] ; out -> mSLV
. mX [ 2 ] = _cg_const_1 [ 2 ] ; out -> mSLV . mX [ 3 ] = _cg_const_1 [ 3 ] ;
out -> mSLV . mX [ 4 ] = _cg_const_1 [ 4 ] ; out -> mSLV . mX [ 5 ] =
...
-> mSLV . mX [ 73 ] = _cg_const_1 [ 73 ] ; ( void ) LC ; ( void ) out ;
return 0 ; }
