...
#include "scd3busMicrogridDroopControlFidelityLevels3Inv_c0dbec00_1_ds_vdf.h"
...
int32_T scd3busMicrogridDroopControlFidelityLevels3Inv_c0dbec00_1_ds_vdf ( const
...
true , false , false , false , false , false } ; int32_T i ; ( void ) t1 ; ( void ) LC ; for ( i = 0 ; i < 112 ; i ++ ) { out -> mVDF . mX [ i ] = _cg_const_1 [ i ] ; } ( void ) LC ; ( void ) out ; return 0 ; }
