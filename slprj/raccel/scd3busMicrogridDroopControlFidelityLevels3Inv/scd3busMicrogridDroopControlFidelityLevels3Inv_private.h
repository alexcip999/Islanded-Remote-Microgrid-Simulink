#ifndef scd3busMicrogridDroopControlFidelityLevels3Inv_private_h_
#define scd3busMicrogridDroopControlFidelityLevels3Inv_private_h_
#include "rtwtypes.h"
...
[ ] , const real_T table [ ] , uint32_T maxIndex ) ; extern void ovrezejxwo ( pbb5q0konc * localDW ) ; extern void fddjv4gxkt ( const real_T c1x0kngrzf [ 3 ] , real_T l02r1ebsov , cfbsix32hq * localB , pbb5q0konc * localDW , fuvhhavfln * localP ) ; extern void enec3qw4da ( dexa4nfqku * localDW ) ; extern void jwxv40soh0 ( const real_T lglgtbng3h [ 4 ] , real_T jtjz4as40d , real_T fsnvojqfdv , hduftbmnkl * localB , dexa4nfqku * localDW ) ;
