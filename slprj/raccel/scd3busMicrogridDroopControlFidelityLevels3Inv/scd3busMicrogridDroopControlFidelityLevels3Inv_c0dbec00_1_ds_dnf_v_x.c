...
#include "scd3busMicrogridDroopControlFidelityLevels3Inv_c0dbec00_1_ds_dnf_v_x.h"
...
int32_T scd3busMicrogridDroopControlFidelityLevels3Inv_c0dbec00_1_ds_dnf_v_x
( const NeDynamicSystem * LC , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * out ) { static boolean_T _cg_const_1 [ 112 ] = { true ,
...
, false , false } ; int32_T i ; ( void ) t1 ; ( void ) LC ; for ( i = 0 ; i <
112 ; i ++ ) { out -> mDNF_V_X . mX [ i ] = _cg_const_1 [ i ] ; } ( void ) LC
; ( void ) out ; return 0 ; }
