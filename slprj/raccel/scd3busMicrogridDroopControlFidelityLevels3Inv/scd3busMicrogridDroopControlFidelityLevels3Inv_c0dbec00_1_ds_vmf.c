...
#include "scd3busMicrogridDroopControlFidelityLevels3Inv_c0dbec00_1_ds_vmf.h"
...
int32_T scd3busMicrogridDroopControlFidelityLevels3Inv_c0dbec00_1_ds_vmf ( const
...
true , true , true , true , true , true , true , true , true , true , true ,
true , false , false , false , false } ; int32_T i ; ( void ) t1 ; ( void )
LC ; for ( i = 0 ; i < 112 ; i ++ ) { out -> mVMF . mX [ i ] = _cg_const_1 [
